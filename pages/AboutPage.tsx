  ...
  return (
    <div className="pb-24 md:pb-12 pt-6 px-4 md:px-8 max-w-5xl mx-auto animate-fade-in">
      ...
      <div className="flex items-center gap-4 mb-8">
        <Button variant="ghost" onClick={() => navigate('/user/home')} className="!p-2 rounded-full md:hidden">
          <ArrowLeft size={24} />
        </Button>
      ...
      <div className="space-y-8">
        ...
        <div className="text-center pt-8 pb-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <p className="text-gray-700 dark:text-gray-300 font-semibold text-sm">Solapur Municipal Corporation</p>
            <p className="text-gray-500 text-xs mt-1">Government of Maharashtra · Smart City Mission Initiative</p>
            <p className="text-gray-400 text-[11px] mt-1">Developed under Digital India Programme · Hosted on GovCloud (MeitY)</p>
            <p className="text-gray-400 text-[11px] mt-2">© {new Date().getFullYear()} Solapur Municipal Corporation. All rights reserved.</p>
            <p className="text-gray-400 text-[10px] mt-1">Content on this portal is governed by the IT Act, 2000 and relevant municipal statutes.</p>
        </div>
